...
def create_app():
    ...
    flask_app.config['MONGODB_SETTINGS'] = {
        ...
        'username': 'coffee',
        'password': 'coffee125',
        'authentication_source': 'coffeebase'
    }
...
def index(cof_user_id):
    ...
    return render_template('index.html', coffees=coffees, counter_false=counter_false, counter_all=counter_all, user=cof_user_id)
...
if __name__ == '__main__':
    ...
    print('Start von NGINX Webserver')
